...
class LiveDataWidget(QWidget):
    def __init__(self):
        ...
        barometer_gnss_layout = QHBoxLayout()
        barometer_gnss_layout.addWidget(self.barometer_group)
        barometer_gnss_layout.addWidget(self.gnss_group)

        # Add all sections inside the main group box
        self.main_group_layout.addLayout(imu_layout)
        self.main_group_layout.addLayout(barometer_gnss_layout)
    ...
    def create_gnss_section(self):
        self.gnss_group = QGroupBox("GNSS", self)
        gnss_layout = QVBoxLayout(self.gnss_group)

        # GNSS section labels
        self.gnss_latitude_label = QLabel("Latitude: Waiting...", self)
        self.gnss_longitude_label = QLabel("Longitude: Waiting...", self)
        self.gnss_altitude_label = QLabel("Altitude: Waiting...", self)

        # Add labels to GNSS layout
        gnss_layout.addWidget(self.gnss_latitude_label)
        gnss_layout.addWidget(self.gnss_longitude_label)
        gnss_layout.addWidget(self.gnss_altitude_label)

        self.gnss_group.setLayout(gnss_layout)
